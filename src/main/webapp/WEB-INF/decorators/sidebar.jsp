	...
	<section class="sidebar">
		...
		<div class="user-panel">
			<div class="pull-left image">
				<img src="${contextName}/resources/dist/img/avatar5.png"
					class="img-circle" alt="User Image">
			</div>
			<div class="pull-left info">
				<p>Muchamad Ardiansyah</p>
		...
		<ul class="sidebar-menu" data-widget="tree">
			...
			<li class="active treeview">
				...
				<ul class="treeview-menu">
					...
					<li><a href="${contextName}/purchase_order"><i class="fa fa-circle-o"></i> Purchase Order</a></li>
					<li><a href="${contextName}/purchase_order_detail"><i class="fa fa-circle-o"></i> Purchase Order Detail</a></li>
				</ul>
			</li>		
		</ul>
	</section>
