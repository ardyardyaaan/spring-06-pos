...
public class ApiProductController {
	...
	@RequestMapping(value="/api/product/get/{catId}", method=RequestMethod.GET)
	public ResponseEntity<ProductModel> getById(@PathVariable("catId") int vId) {
	...
	@RequestMapping(value="/api/product/{catId}", method=RequestMethod.DELETE)
	public ResponseEntity<ProductModel> delApi(@PathVariable("catId") Integer vid){
		ResponseEntity<ProductModel> result = null;
		try {
