...
<script>
			...
			success : function(result){
				...
				$.each(result, function(index, item){
					var dataRow ='<tr>'+
						...
						'</td>'+
						'</tr>';
					//di dalam list-data menampilkan dataRow
	...
	function addData($dagang){
		...
		$.ajax({
			...
			// data type berupa JSON
			dataType:'json',
			// mengirim parameter data yang ditangkap oleh api controller sebagai request body
	...
	$('#list-data').on('click','.btn-edit', function(){
		...
		$.ajax({
			...
			success : function(result){
				//mengganti judul modal
				$("#modal-title").html("Edit Data Package");
				//mengisi content dengan variable result
				$("#modal-data").html(result);
				//menampilkan modal pop up
				$("#modal-dagang").modal('show');
	...
	$('#list-data').on('click','.btn-detail', function(){
		...
		$.ajax({
			...
			success : function(result){
				//mengganti judul modal
				$("#modal-title").html("Detail Data Package");
				//mengisi content dengan variable result
				$("#modal-data").html(result);
				//menampilkan modal pop up
				$("#modal-dagang").modal('show');
	...
	$('#list-data').on('click','.btn-delete', function(){
		...
		$.ajax({
			...
			success : function(result){
				//mengganti judul modal
				$("#modal-title").html("Delete Data Package");
				//mengisi content dengan variable result
				$("#modal-data").html(result);
				//menampilkan modal pop up
				$("#modal-dagang").modal('show');
